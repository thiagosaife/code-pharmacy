...
/** Drift watermark colors per mode (indexed i % 3). */
export const DRIFT_COLORS: Record<Mode, [string, string, string] | null> = {
  decode: ["#c9c4b4", "#8a877a", "#d98ac6"],
  flicker: ["#9adfe8", "#8a877a", "#4ac8d8"],
  hover: null, // hover uses neon hsl hues
};

export const DRIFT_HUES = [55, 335, 185]; // yellow, pink, teal
